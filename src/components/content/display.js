      ...
      <article class="display-content">
        ...
        <div>
          ...
          <ul className="resources">
            ...
            <li className="resource-item">
              <a className="" href="https://flexbox.io/" target="_blank">
            ...
            <li className="resource-item resource-item-last">
              <a href="https://developer.mozilla.org/es/docs/Web/CSS/CSS_Flexible_Box_Layout/Conceptos_Basicos_de_Flexbox" target="_blank">
        ...
        <div>
          ...
          <ul className="resources">
            ...
            <li className="resource-item resource-item-3">
              <a href="https://gridbyexample.com/examples/" target="_blank">
